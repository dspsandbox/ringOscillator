...
# module references:
# bin2gray, counterDiff, gray2bin, sync
...
proc create_hier_cell_PS { parentCell nameHier } {
  ...
  connect_bd_net -net rst_ps7_0_200M_peripheral_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_200M/peripheral_aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ck_io8 [ create_bd_port -dir I -type clk ck_io8 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {200000000} \
 ] $ck_io8
  set ck_io9 [ create_bd_port -dir O -from 0 -to 0 ck_io9 ]
  ...
  # Create instance: bin2gray_0, and set properties
  set block_name bin2gray
  set block_cell_name bin2gray_0
  if { [catch {set bin2gray_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bin2gray_0 eq "" } {
  ...
  # Create instance: counterDiff_0, and set properties
  set block_name counterDiff
  set block_cell_name counterDiff_0
  if { [catch {set counterDiff_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $counterDiff_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: gray2bin_0, and set properties
  set block_name gray2bin
  set block_cell_name gray2bin_0
  if { [catch {set gray2bin_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $gray2bin_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  if { [catch {set sync_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.PORT_WIDTH {32} \
   CONFIG.SYNC_STAGES {2} \
 ] $sync_0
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins PS/M00_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]

  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins counterDiff_0/maxIntegrationCycles]
  connect_bd_net -net bin2gray_0_gray [get_bd_pins bin2gray_0/gray] [get_bd_pins sync_0/dataIn]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins bin2gray_0/bin] [get_bd_pins c_counter_binary_0/Q]
  connect_bd_net -net ck_io11_1 [get_bd_ports ck_io8] [get_bd_pins util_ds_buf_0/BUFG_I] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net counterDiff_0_diff [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins counterDiff_0/diff]
  connect_bd_net -net gray2bin_0_bin [get_bd_pins counterDiff_0/counter] [get_bd_pins gray2bin_0/bin]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PS/FCLK_CLK0] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins counterDiff_0/clk] [get_bd_pins gray2bin_0/clk] [get_bd_pins sync_0/clk]
  connect_bd_net -net rst_ps7_0_200M_peripheral_aresetn [get_bd_pins PS/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn]
  connect_bd_net -net sync_0_dataOut [get_bd_pins gray2bin_0/gray] [get_bd_pins sync_0/dataOut]
  connect_bd_net -net util_ds_buf_0_BUFG_O [get_bd_pins bin2gray_0/clk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins util_ds_buf_0/BUFG_O]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_ports ck_io9] [get_bd_pins util_vector_logic_0/Res]
